...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement("img", { src: "images/logowithtext.png", width: "130", height: "26" }));
};
...
var Icon$10 = function (props) {
    ...
    return (React__default['default'].createElement("img", { src: "images/logo.png", width: "92", height: "92" }));
};
...
var Icon$_ = function (props) {
    return (React__default['default'].createElement("img", { src: "logo.png", width: "32", height: "32" }));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default['default'].createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default['default'].createElement(Icon$1P, { color: "#fff" }) : React__default['default'].createElement(Icon$1S, { color: "#fff" }) }, children));
};
...
var templateObject_1$12, templateObject_2$x, templateObject_3$f, templateObject_4$c;
...
var templateObject_1$$, templateObject_2$w, templateObject_3$e, templateObject_4$b;
...
var templateObject_1$X, templateObject_2$u, templateObject_3$d, templateObject_4$a;
...
var templateObject_1$V, templateObject_2$t, templateObject_3$c, templateObject_4$9;
...
var templateObject_1$Q, templateObject_2$s, templateObject_3$b, templateObject_4$8, templateObject_5$6;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://swap.nsavdex.io/swap?outputCurrency=0x4837eB79E05C3aC845C010060C488992d1f1AcE0", target: "_blank" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt1: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", backgroundAlt3: "#113356", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", textSubtle1: "#FFFFFF", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#FFFFFF", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", backgroundAlt1: "#141d3c", backgroundAlt2: "rgba(39, 38, 44, 0.7)", backgroundAlt3: "#113356", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#FFFFFF", textSubtle1: "#FFFFFF", disabled: "#524B63", gradients: {
...
var templateObject_1$t, templateObject_2$j, templateObject_3$9, templateObject_4$7, templateObject_5$5, templateObject_6$3, templateObject_7$2;
...
var Icon = function (props) {
    return (React__default['default'].createElement("img", { src: "/images/logo.png", width: "128", height: "128" }));
};
...
styled__default['default'](Icon$1)(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(RotatingPancakeIcon, { width: size * 0.5 + "px" })));
};
var templateObject_1$s, templateObject_2$i, templateObject_3$8, templateObject_4$6, templateObject_5$4;
    ...
    return (React__default['default'].createElement(StyledSubMenuItems, __assign({ justifyContent: [isMobileOnly ? "flex-end" : "start", null, "center"] }, props, { pl: ["12px", null, "0px"], "$isMobileOnly": isMobileOnly }), items.map(function (_a) {
        ...
        return label && (React__default['default'].createElement(Box, { key: label, mr: "20px" },
            React__default['default'].createElement(MenuItem$1, { href: href, isActive: href === activeItem, variant: "subMenu" },
                iconName && (React__default['default'].createElement(IconComponent, { color: href === activeItem ? "#fff" : "textSubtle", iconName: iconName, mr: "4px" })),
                label)));
    })));
};
...
var ThemeSwitcher = function (_a) {
    ...
    return (React__default['default'].createElement(Toggle, { checked: isDark, defaultColor: "textDisabled", checkedColor: "textDisabled", onChange: function () { return toggleTheme(!isDark); }, scale: "md", startIcon: function (isActive) {
            ...
            if (isActive === void 0) { isActive = false; }
            return React__default['default'].createElement(IconComponent, { iconName: "Moon", color: isActive ? "secondary" : "backgroundAlt1" });
        } }));
};
...
var BottomNavItem = function (_a) {
    ...
    var bottomNavItemContent = (React__default['default'].createElement(Flex, { flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100%" },
        iconName && (React__default['default'].createElement(AnimatedIconComponent, { iconName: iconName, height: "22px", width: "21px", color: isActive ? "secondary" : "textSubtle", isActive: isActive })),
...
var StyledBottomNav = styled__default['default'](Flex)(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  border-top: 1px solid ", ";\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n  z-index: 20;\n"], ["\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  border-top: 1px solid ", ";\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n  z-index: 20;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.backgroundAlt3;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.cardBorder;
});
    ...
    return (React__default['default'].createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default['default'].createElement(StyledSocialLinks, { order: [2], pb: ["0px", null, "0px"], mb: ["0", null, "10px"] }),
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://swap.nsavdex.io/swap?outputCurrency=0x4837eB79E05C3aC845C010060C488992d1f1AcE0", target: "_blank", scale: "sm", style: { color: "#000" }, endIcon: React__default['default'].createElement(Icon$29, { color: "#000" }) }, buyCakeLabel))))));
};
...
var MenuItems = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default['default'].createElement(DropdownMenu, { key: label + "#" + href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default['default'].createElement(MenuItem$1, __assign({}, linkProps, { isActive: isActive, statusColor: statusColor }), label || React__default['default'].createElement(IconComponent, { iconName: icon, color: isActive ? "#fff" : "textSubtle" }))));
    })));
};
...
var NoProfileMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "primary" },
    React__default['default'].createElement(Icon$4, { color: "#fff", width: "24px" }))); };
    ...
    return (React__default['default'].createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default['default'].createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default['default'].createElement(Box, { p: "24px" },
                ...
                React__default['default'].createElement(Button, __assign({ as: "a", href: "https://docs.swap.nsavdex.io/get-started/connection-guide", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
