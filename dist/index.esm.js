...
var Logo$2 = function (_a) {
    ...
    return (React__default.createElement("img", { src: "images/logowithtext.png", width: "130", height: "26" }));
};
...
var Icon$10 = function (props) {
    ...
    return (React__default.createElement("img", { src: "images/logo.png", width: "92", height: "92" }));
};
...
var Icon$_ = function (props) {
    return (React__default.createElement("img", { src: "logo.png", width: "32", height: "32" }));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default.createElement(Icon$1P, { color: "#fff" }) : React__default.createElement(Icon$1S, { color: "#fff" }) }, children));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://swap.nsavdex.io/swap?outputCurrency=0x4837eB79E05C3aC845C010060C488992d1f1AcE0", target: "_blank" },
...
var Icon = function (props) {
    return (React__default.createElement("img", { src: "/images/logo.png", width: "128", height: "128" }));
};
    ...
    return (React__default.createElement(StyledSubMenuItems, __assign({ justifyContent: [isMobileOnly ? "flex-end" : "start", null, "center"] }, props, { pl: ["12px", null, "0px"], "$isMobileOnly": isMobileOnly }), items.map(function (_a) {
        ...
        return label && (React__default.createElement(Box, { key: label, mr: "20px" },
            React__default.createElement(MenuItem$1, { href: href, isActive: href === activeItem, variant: "subMenu" },
                iconName && (React__default.createElement(IconComponent, { color: href === activeItem ? "#fff" : "textSubtle", iconName: iconName, mr: "4px" })),
                label)));
    })));
};
...
var ThemeSwitcher = function (_a) {
    ...
    return (React__default.createElement(Toggle, { checked: isDark, defaultColor: "textDisabled", checkedColor: "textDisabled", onChange: function () { return toggleTheme(!isDark); }, scale: "md", startIcon: function (isActive) {
            ...
            if (isActive === void 0) { isActive = false; }
            return React__default.createElement(IconComponent, { iconName: "Moon", color: isActive ? "secondary" : "backgroundAlt1" });
        } }));
};
...
var BottomNavItem = function (_a) {
    ...
    var bottomNavItemContent = (React__default.createElement(Flex, { flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100%" },
        iconName && (React__default.createElement(AnimatedIconComponent, { iconName: iconName, height: "22px", width: "21px", color: isActive ? "secondary" : "textSubtle", isActive: isActive })),
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default.createElement(StyledSocialLinks, { order: [2], pb: ["0px", null, "0px"], mb: ["0", null, "10px"] }),
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://swap.nsavdex.io/swap?outputCurrency=0x4837eB79E05C3aC845C010060C488992d1f1AcE0", target: "_blank", scale: "sm", style: { color: "#000" }, endIcon: React__default.createElement(Icon$29, { color: "#000" }) }, buyCakeLabel))))));
};
...
var MenuItems = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default.createElement(DropdownMenu, { key: label + "#" + href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default.createElement(MenuItem$1, __assign({}, linkProps, { isActive: isActive, statusColor: statusColor }), label || React__default.createElement(IconComponent, { iconName: icon, color: isActive ? "#fff" : "textSubtle" }))));
    })));
};
...
var NoProfileMenuIcon = function () { return (React__default.createElement(MenuIconWrapper, { borderColor: "primary" },
    React__default.createElement(Icon$4, { color: "#fff", width: "24px" }))); };
    ...
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default.createElement(Box, { p: "24px" },
                ...
                React__default.createElement(Button, __assign({ as: "a", href: "https://docs.swap.nsavdex.io/get-started/connection-guide", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
